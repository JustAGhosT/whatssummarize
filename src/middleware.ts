...
export async function middleware(request: NextRequest) {
  ...
  const protectedRoutes = ['/admin', '/personal', '/groups', '/cross-platform-groups', '/customize', '/distribution', '/notifications']
  ...
  // If user is signed in and the current route is a login/signup route, redirect to home
